...
Manages user-specific config in centralized user directory.
"""
...
class UserConfigManager:
    ...
    def __init__(self):
        ...
        self.config_dir = Path(self.user_dir_manager.get_config_dir())
        self._ensure_config_dir_exists()
        
    def _get_user_config_dir(self) -> Path:
        """Get user-specific config directory."""
        return Path(self.user_dir_manager.get_config_dir())
